# 🛡️ Đánh giá an ninh hệ thống Firewall và IDS bằng Snort & Iptables
...
## 🏗️ Mô hình mạng thực nghiệm (Network Topology)
...
## 📂 Tài liệu & Demo
* [Xem báo cáo cấu hình chi tiết (PDF)](link-den-file-pdf-cua-ban)
* [Xem Video Demo thực tế hệ thống](https://youtu.be/NGW7gABLzlo)
